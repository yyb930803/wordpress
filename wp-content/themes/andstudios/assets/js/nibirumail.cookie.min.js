...
if (cookie_policy_url === undefined) {
    var cookie_policy_url = 'https://winefully.com/privacy-policy';
}
if (nibirumail_advice_text === undefined) {
    var nibirumail_advice_text = window.location.hostname + " utilizza i cookie per offrirti una migliore esperienza di navigazione. Usando il nostro servizio accetti l'impegno di cookie in accordo con la nostra cookie policy. <a target=\"_blank\" href=\"" + cookie_policy_url + "\">Scopri di più</a>. <a class=\"nibirumail_agreement\" href=\"javascript:;\">Accetto.</a>";
}
