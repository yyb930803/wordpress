                ...
                <tr>
                    ...
                    <td class="nasa-td-30">
                        <div class="nasa-compare-label<?php echo !$count_compare ? ' hidden-tag' : ''; ?>">
                            <a class="nasa-compare-clear-all nasa-hover-underline color-gray" href="javascript:void(0);" title="<?php esc_attr_e('Clear All', 'elessi-theme'); ?>"><?php esc_html_e('Clear All', 'elessi-theme'); ?></a>
