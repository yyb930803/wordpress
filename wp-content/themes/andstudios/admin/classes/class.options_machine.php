...
class Options_Machine {
    ...
    public static function optionsframework_media_uploader_function($id, $std, $mod) {
        ...
        if (function_exists('wp_enqueue_media')) {
            $uploader .= '<span class="button media_upload_button" id="' . $id . '">' . esc_html__('Upload', 'elessi-theme') . '</span>';
            ...
            $uploader .= '<span class="button remove-image ' . $hide . '" id="reset_' . $id . '" title="' . $id . '">' . esc_html__('Remove', 'elessi-theme') . '</span>';
        } else {
    ...
    public static function optionsframework_slider_function($id, $std, $oldorder, $order) {
        ...
        $slider .= '<div class="upload_button_div"><span class="button media_upload_button" id="' . $id . '_' . $order . '">' . esc_html__('Upload', 'elessi-theme') . '</span>';
        ...
        $slider .= '<span class="button remove-image ' . $hide . '" id="reset_' . $id . '_' . $order . '" title="' . $id . '_' . $order . '">' . esc_html__('Remove', 'elessi-theme') . '</span>';
        $slider .= '</div>' . "\n";
