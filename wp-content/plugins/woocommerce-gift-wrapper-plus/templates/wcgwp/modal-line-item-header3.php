...
<div class="giftwrap_header_wrapper">
    <p class="giftwrap_header"><a data-toggle="modal" data-target=".giftwrapper_products_modal<?php echo $label . '-' . $count; ?>" class="btn"><?php echo apply_filters( 'wcgwp_add_wrap_prompt', esc_html__( '+ 3 bottle box', 'woocommerce-gift-wrapper-plus' ) ); ?></a></p>
</div>