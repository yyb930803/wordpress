...
function nasa_sc_share($atts, $content = null) {
    ...
    $share_wrap_start .= '<ul class="social-icons nasa-share' . ($size != '' ? ' ' . esc_attr($size) : '') . ($el_class != '' ? ' ' . esc_attr($el_class) : '') . '"><p class="condividi">Condividi sui social</p>';
    ...
    if (isset($nasa_opt['social_icons']['linkedin']) && $nasa_opt['social_icons']['linkedin']) {
        $share .=
        '<li>' .
            '<a href="//linkedin.com/shareArticle?mini=true&amp;url=' . esc_url($permalink) . '" target="_blank" class="icon" title="' . esc_attr__('Share on Linkedin', 'nasa-core') . '" rel="nofollow">' .
    ...
    if (isset($nasa_opt['social_icons']['telegram']) && $nasa_opt['social_icons']['telegram']) {
        $share .=
        '<li>' .
            '<a href="//telegram.me/share/?url=' . esc_url($permalink) . '" target="_blank" class="icon" title="' . esc_attr__('Share on Telegram', 'nasa-core') . '" rel="nofollow">' .
    ...
    if (isset($nasa_opt['social_icons']['vk']) && $nasa_opt['social_icons']['vk']) {
        $share .=
        '<li>' .
            '<a href="//vk.com/share.php?url=' . esc_url($permalink) . '&amp;title=' . esc_attr($post_title) . '&amp;image=' . esc_attr($featured_image_2) . '" target="_blank" class="icon" title="' . esc_attr__('Share on VK', 'nasa-core') . '" rel="nofollow">' .
                '<i class="fa fa-vk"></i>' .
            '</a>' .
        '</li>';
    }
...
function nasa_sc_follow($atts, $content = null) {
     ...
     */
    if ($vk) {
        $follow .= '<a href="' . esc_url($vk) . '" target="_blank" class="icon icon_vk" title="' . esc_attr__('Follow us on VK', 'nasa-core') . '" rel="nofollow"><i class="fa fa-vk"></i></a>';
    }
     ...
     */
    if ($linkedin) {
        $follow .= '<a href="' . esc_url($linkedin) . '" target="_blank" class="icon icon_linkedin" title="' . esc_attr__('LinkedIn', 'nasa-core') . '" rel="nofollow"><i class="fa fa-linkedin"></i></a>';
    }
     ...
     */
    if ($youtube) {
        $follow .= '<a href="' . esc_url($youtube) . '" target="_blank" class="icon icon_youtube" title="' . esc_attr__('Follow us on YouTube', 'nasa-core') . '" rel="nofollow"><i class="fa fa-youtube-play"></i></a>';
    }
     ...
     */
    if ($tumblr) {
        $follow .= '<a href="' . esc_url($tumblr) . '" target="_blank" class="icon icon_tumblr" title="' . esc_attr__('Follow us on Tumblr', 'nasa-core') . '" rel="nofollow"><i class="fa fa-tumblr"></i></a>';
    }
     ...
     */
    if ($weibo) {
        $follow .= '<a href="' . esc_url($weibo) . '" target="_blank" class="icon icon_weibo" title="' . esc_attr__('Weibo', 'nasa-core') . '" rel="nofollow"><i class="fa fa-weibo"></i></a>';
    }
     ...
     */
    if ($amazon) {
        $follow .= '<a href="' . esc_url($amazon) . '" target="_blank" class="icon icon_amazon" title="' . esc_attr__('Amazon', 'nasa-core') . '" rel="nofollow"><i class="fa fa-amazon"></i></a>';
    }
