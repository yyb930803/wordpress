jQuery(document).ready(function($){
    ...
    if($('.nasa-override-pri-color-flag input[type="checkbox"]').is(':checked')){
        $('.nasa-override-pri-color').fadeIn(200);
    }
    $('body').on('change', '.nasa-override-pri-color-flag input[type="checkbox"]', function(){
	if($(this).is(':checked')){
	    $('.nasa-override-pri-color').fadeIn(200);
	}else{
	    $('.nasa-override-pri-color').fadeOut(200);
	}
    });
